...
--- How To Use ---
    Simply define the implementation define in one and only one cpp file before you include the header, and that will add the code to link the library
-- #define RL_TEXT_IMPLEMENTATION
-- #include "rlText.h"

    Do NOT add RL_TEXT_IMPLEMENTATION to a header file or you will get multiple definition link errors.
